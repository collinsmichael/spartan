...
ImageLoadSeg            equ     0xC0     ; <=07Fh because of "push byte ImageLoadSeg" instructions
...
ReadSectorLBANext:
        ...
        push    0
        push    0 ; 32-bit LBA only: up to 2TB disks
        push    eax
        push    es
        push    bx
        push    1 ; sector count word = 1
        push    16 ; packet size byte = 16, reserved byte = 0
        ...
        add     eax, 1             ; adjust LBA for next sector
...
ProgramName     db      "RAMDISK IMG"   ; name and extension each must be
